...
to associate properties with object versions is to use the [Object Version Properties extension](./object-version-properties.md).
...
the [Packaging Format Registry extension](./packaging-format-registry.md). It is required and must be a valid packaging format name
