...
public class TimestampDirectoryComparator implements Comparator<Path> {
    public static final TimestampDirectoryComparator INSTANCE = new TimestampDirectoryComparator();
